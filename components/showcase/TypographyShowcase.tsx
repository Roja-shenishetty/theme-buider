...
const codeScaleMatrix = `<div className="w-full divide-y divide-primary/5">
  {typeScale.map((item) => (
    <div key={item.name} className="grid grid-cols-1 md:grid-cols-12 items-center gap-6 py-8 group cursor-pointer hover:bg-primary/5 transition-all px-4 radius-md">
      ...
      <div className="md:col-span-7">
        <Typography variant={item.variant} className="truncate group-hover:text-primary transition-colors">
...
const codeWeightSystem = `<div className="space-y-4">
...
const codeNumericalLogic = `<div className="space-y-6">
...
const codeEditorialPatterns = `<div className="grid md:grid-cols-3 gap-wide">
...
const codeIntegratedUI = `<div className="card max-w-md bg-background border-primary/20 shadow-xl shadow-primary/5">
  ...
  return (
    <section className="space-section animate-fade-up">
      <div className="space-group mb-6 relative">
        ...
        <Typography variant="h3" className="tracking-tight font-bold text-primary/90 relative z-10 flex items-center gap-2">
          {title}
        </Typography>
        {description && (
...
export function TypographyShowcase() {
  ...
  return (
    <div className="page-container space-page">
      ...
      >
        <ComponentWrapper title="Typography // React_Components" code={codeScaleMatrix}>
          <div className="w-full divide-y divide-primary/5 p-4">
            {typeScale.map((item) => (
              <div
                key={item.name}
      ...
      <div className="grid md:grid-cols-2 gap-wide">
        <ShowcaseSection title="Weight System" description="Defining emphasis levels.">
          <ComponentWrapper title="CSS // Font_Weights" code={codeWeightSystem}>
        ...
        <ShowcaseSection title="Numerical Logic" description="Optimized for dashboards.">
          <ComponentWrapper title="Data // Font_Variants" code={codeNumericalLogic}>
      ...
      <ShowcaseSection title="Editorial Patterns" description="Handling line-height and letter-spacing for large text blocks.">
        <ComponentWrapper title="Typography // Spacing_Rules" code={codeEditorialPatterns}>
          <div className="grid md:grid-cols-3 gap-wide p-4">
            <div className="space-group">
              <Typography variant="label" className="text-primary underline decoration-primary/30">Tracking (Wide)</Typography>
              <Typography className="tracking-widest uppercase text-xs font-bold leading-none">
                Modernist Approach
      ...
      <ShowcaseSection title="Integrated UI" description="A composition of various typography tokens.">
        <ComponentWrapper title="Layout // Compound_Text" code={codeIntegratedUI}>
          <div className="flex justify-center p-4">
            <div className="card max-w-md bg-background border-primary/20 shadow-xl shadow-primary/5">
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-primary/5 flex items-center justify-between">
                   <Typography variant="small" className="font-bold">Venkateshwarlu A.</Typography>
                   <Typography variant="caption" className="opacity-50 underline cursor-pointer hover:text-primary transition-colors">Read More</Typography>
                </div>
              </div>
            </div>
          </div>
