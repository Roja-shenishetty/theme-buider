...
const codeInternalPadding = `<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-wide">
  {spacing.map((s) => (
...
const codeExternalMargins = `<div className="flex flex-wrap items-end gap-wide">
  {["2", "4", "8"].map((m) => (
...
const codeGridGap = `<div className="space-group w-full max-w-xl">
  {["2", "4", "8"].map((g) => (
...
const codeVerticalStacking = `<div className="grid md:grid-cols-2 gap-wide w-full">
...
export function SpacingShowcase() {
  ...
  return (
    <div className="page-container space-page">
      ...
      >
        <ComponentWrapper title="Layout // Container_Padding" code={codeInternalPadding}>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-wide p-4">
            {spacing.map((s) => (
              <div key={s.key} className="flex flex-col gap-2">
                <div className="flex items-center justify-between px-1">
                  <code className="text-xs text-primary font-bold">p-{s.key}</code>
      ...
      >
        <ComponentWrapper title="Layout // Component_Margins" code={codeExternalMargins}>
      ...
      >
        <ComponentWrapper title="Layout // Grid_Gap" code={codeGridGap}>
          <div className="space-group w-full max-w-xl p-4">
            {["2", "4", "8"].map((g) => (
              <div key={g} className="space-y-2">
                <div className="flex items-center justify-between opacity-50">
                  <Typography variant="label" className="text-[10px]">Gap Scale {g}</Typography>
      ...
      >
        <ComponentWrapper title="Layout // Y_Axis_Stacking" code={codeVerticalStacking}>
          <div className="grid md:grid-cols-2 gap-wide w-full p-4">
             <div className="space-y-4 bg-muted/20 pad-6 radius-xl border border-primary/5">
                <div className="h-3 w-1/3 bg-primary/20 radius-full" />
                <div className="h-3 w-full bg-primary/10 radius-full" />
                <div className="h-3 w-2/3 bg-primary/10 radius-full" />
             ...
             <div className="space-y-8 bg-muted/20 pad-6 radius-xl border border-primary/5">
                ...
                <div className="h-3 w-full bg-primary/10 radius-full" />
                <div className="h-3 w-2/3 bg-primary/10 radius-full" />
                <Typography variant="caption" className="text-primary font-bold">space-y-8</Typography>
             </div>
          </div>
        </ComponentWrapper>
      </Section>
