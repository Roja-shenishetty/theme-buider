...
export function ControlledSection() {
  ...
  return (
    <section className="space-section animate-fade-up">
        ...
        <div className="flex items-center justify-between bg-background/50 pad-3 radius-md border border-primary/5 backdrop-blur-sm">
          <div className="flex items-center gap-3">
            <div className={`w-2 h-2 radius-full transition-all duration-500 ${
              isOpen ? "bg-primary shadow-[0_0_8px_#var(--primary)]" : "bg-muted-foreground/30"
            }`} />
      ...
      <div className="mt-6 bg-foreground text-background pad-4 radius-lg flex items-center justify-between group cursor-pointer hover:bg-foreground/90 transition-all">
